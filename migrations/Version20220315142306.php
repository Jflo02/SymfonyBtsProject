 ...
 */
final class Version20220315142306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vaccin_type (id INT AUTO_INCREMENT NOT NULL, vaccin_id_id INT NOT NULL, nom VARCHAR(255) NOT NULL, stock INT DEFAULT NULL, INDEX IDX_43B6EB182E55F6D1 (vaccin_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vaccination (id INT AUTO_INCREMENT NOT NULL, date_vaccination DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vaccination_patient (vaccination_id INT NOT NULL, patient_id INT NOT NULL, INDEX IDX_14325DF84DDCCFA3 (vaccination_id), INDEX IDX_14325DF86B899279 (patient_id), PRIMARY KEY(vaccination_id, patient_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vaccination_infirmier (vaccination_id INT NOT NULL, infirmier_id INT NOT NULL, INDEX IDX_D36E70FD4DDCCFA3 (vaccination_id), INDEX IDX_D36E70FDC2BE0752 (infirmier_id), PRIMARY KEY(vaccination_id, infirmier_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vaccination_vaccin (vaccination_id INT NOT NULL, vaccin_id INT NOT NULL, INDEX IDX_86DE81AF4DDCCFA3 (vaccination_id), INDEX IDX_86DE81AF9B14AC76 (vaccin_id), PRIMARY KEY(vaccination_id, vaccin_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
