...
const infirmierPage = (props) => {
    ...
    useEffect(() => {
        axios.get("http://127.0.0.1:8000/api/infirmiers")
    ...
    const handleDelete = (id) => {
        console.log(id);
        axios.delete("http://127.0.0.1:8000/api/infirmiers/" + id).then(Response => console.log(Response));
    }
    ...
    const paginatedInfirmier = filteredInfirmier.length > itemsPerPage ? filteredInfirmier.slice(
        start, start + itemsPerPage) : filteredInfirmier;
    ...
    return (
        <>
            <div className="mb-3 d-flex justify-content-between align-items-center">
                ...
                <Link to="/infirmier/new" className="btn btn-primary">Créer un infirmier</Link>
            </div>
